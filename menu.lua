...
Menu.new = function()
    ...
    function self.gamepadShortcuts()
        ...
        printNextPadShortcut("Left stick up    : N/A                        --- Y  : N/A")
        printNextPadShortcut("Left stick left  : N/A                        --- X  : N/A")
        printNextPadShortcut("Left stick right : N/A                        --- B  : to activate MEGA BOMB")
        printNextPadShortcut("Left stick down  : N/A                        --- A  : to fire")
        printNextPadShortcut("D-Pad up    : to increase the weapon (debug)  --- Right stick up    : N/A")
        printNextPadShortcut("D-Pad left  : select the left weapon (debug)  --- Right stick left  : N/A")
